...
var getSomeMmm = function getSomeMmm() {
  var config = {
    headers: {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('https://icanhazdadjoke.com/', config).then(function (res) {
    return document.querySelector('#cuteJoke').innerHTML = res.data.joke;
  });
  return 'Mmm, u are cute';
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getSomeMmm);
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _getSomeMmm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getSomeMmm */ "./src/getSomeMmm.js");
...
var someImage = document.querySelector('#imageId');
someImage.src = _assets_image_png__WEBPACK_IMPORTED_MODULE_2__;
document.querySelector('#cuteBtn').addEventListener('click', function () {
  return (0,_getSomeMmm__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
})();

/******/ })()
;
//# sourceMappingURL=bundle.f8bc5e819fbe2aa3ad45.js.map